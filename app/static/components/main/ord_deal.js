define(["./ord_deal.ui"], function(Ord_dealUI){
  var Ord_deal = Ext.extend(Ord_dealUI,{
    constructor: function  (config) {
      config = config || {};
      Ext.apply(this, config);
    Ord_deal.superclass.constructor.call(this)
    },

    initComponent: function(){
    Ord_deal.superclass.initComponent.call(this);
      var self = x = this;
      var offset_x = 20;
      var offset_y = 25;
      ...
      self._exportPdf.on({
        click: function(){
            if(self._frmFilter.isValid()){
                ...
                Ext.apply(params, { model: 'OrdDealInq'} )
      ...
      self._search.on({
        click:  function() {
            var params = self._frmFilter.serializeNotBlank();
           self._grd.fetch(Ext.apply({model: 'OrdDealInq'}, params)); 
        }
      });
